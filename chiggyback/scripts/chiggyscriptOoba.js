$(document).ready(function() {
    ...
    window.setCharacter = function(value) {
        character = value;
        document.getElementById('printCharacter').innerText = 'Selected Character: ' + character;
    }
    ...
    $("#sendButton").click(function() {
        ...
        function constructMessages() {
            ...
            for (var i = 0; i < conversationHistory.length; i++) {
                ...
                // else if (message.role === "user" && message.type === "text") {
                //     if (currentMessage) {
                //         messages.push(currentMessage);
                //     }
                //     currentMessage = {
    ...
    function sendPayloadToBackend(payload) {
        $.ajax({
            url: 'chiggyback/scripts/chiggybackOoba.php', // Send the request to piccyback.php
            type: 'POST',
